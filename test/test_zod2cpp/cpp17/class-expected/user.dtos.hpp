...
namespace USER_DTOS {
    ...
    class UpdateUserUseCaseDto : public CreateUserUseCaseDto {};
    ...
    public:
        ...
        const UpdateUserUseCaseDto& get_update_user_use_case_dto() const { return this->update_user_use_case_dto; }
        UpdateUserUseCaseDto& get_mut_update_user_use_case_dto() { return this->update_user_use_case_dto; }
        void set_update_user_use_case_dto(const UpdateUserUseCaseDto& value) { this->update_user_use_case_dto = value; }
...
namespace USER_DTOS {
    ...
    inline void to_json(nlohmann::json& j, const CreateUserUseCaseDto& x) {
        j["name"] = x.get_name();
        j["email"] = x.get_email();
        USER_DTOS::set_opt<std::uint64_t>(j, "age", x.get_age());
        j["role"] = x.get_role();
    }
    ...
    inline void from_json(const nlohmann::json& j, CreateUserUseCaseDto& x) {
        ...
        x.set_age(USER_DTOS::get_opt<std::uint64_t>(j, "age"));
    ...
    inline void from_json(const nlohmann::json& j, UserDtos& x) {
        ...
        x.set_update_user_use_case_dto(j.at("updateUserUseCaseDto").get<UpdateUserUseCaseDto>());
