...
namespace zodtocppclass {
    ...
    private:
        ...
        DiscriminantUnionItem discriminated_union_item;
    ...
    public:
        ...
        const DiscriminantUnionItem& get_discriminated_union_item() const { return this->discriminated_union_item; }
        DiscriminantUnionItem& get_mut_discriminated_union_item() { return this->discriminated_union_item; }
        void set_discriminated_union_item(const DiscriminantUnionItem& value) { this->discriminated_union_item = value; }
...
namespace zodtocppclass {
    ...
    inline void from_json(const json& j, CppSupportedSchemas& x) {
        ...
        x.set_discriminated_union_item(j.at("discriminatedUnionItem").get<DiscriminantUnionItem>());
