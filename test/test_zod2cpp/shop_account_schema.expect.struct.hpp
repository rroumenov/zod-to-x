...
namespace zodtocpp {
    ...
    using ContactInfo = boost::variant<EmailContact, PhoneContact, SocialContact>;
    ...
    using PaymentMethod = boost::variant<CreditCard, PayPal, BankTransfer>;
...
namespace zodtocpp {
    ...
    inline void to_json(json& j, const ContactInfo& x) {
        if (x.type() == typeid(EmailContact)) {
            j = boost::get<EmailContact>(x);
        }
        else if (x.type() == typeid(PhoneContact)) {
            j = boost::get<PhoneContact>(x);
        }
        else if (x.type() == typeid(SocialContact)) {
            j = boost::get<SocialContact>(x);
        }
        else {
    ...
    inline void to_json(json& j, const PaymentMethod& x) {
        if (x.type() == typeid(CreditCard)) {
            j = boost::get<CreditCard>(x);
        }
        else if (x.type() == typeid(PayPal)) {
            j = boost::get<PayPal>(x);
        }
        else if (x.type() == typeid(BankTransfer)) {
            j = boost::get<BankTransfer>(x);
        }
        else {
