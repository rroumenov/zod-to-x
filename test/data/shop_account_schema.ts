...
const ContactInfoSchema = z
    .union([EmailContactSchema, PhoneContactSchema, SocialContactSchema])
    .zod2x("ContactInfo");
...
const PaymentMethodSchema = z
    .discriminatedUnion("methodType", [CreditCardSchema, PayPalSchema, BankTransferSchema])
    .zod2x("PaymentMethod");

// Main Schema
export const ShopAccountModel = z
    .object({
        id: z.string().uuid(),
